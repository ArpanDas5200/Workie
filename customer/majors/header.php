		...
		<div class="container-fluid tt-top-line">
			<div class="row">
				<div class="tt-logo-container">
					<!-- mobile logo -->
					<a class="tt-logo tt-logo-alignment" href="login"><img src="images/custom/logo.png" alt=""></a>
					<!-- /mobile logo -->
				</div>
			</div>
		</div>
				...
				<div class="tt-col-obj tt-obj-options obj-move-right">
						...
						<div class="tt-search tt-dropdown-obj">
							...
							<div class="tt-dropdown-menu">
								<div class="container">
									<form >
										<div class="tt-col">
											<input type="text" class="tt-search-input" id = "search"  name = "search" placeholder="Search Products...">
											<button class="tt-btn-search" type="submit" id = "submit-search" name="submit-search"  ></button>
										</div>
										<div class="tt-col">
					...
					<div class="tt-desctop-parent-cart tt-parent-box">
						<div class="tt-cart tt-dropdown-obj" data-tooltip="Cart" data-tposition="bottom">
							<a href="shoppingcart" class="tt-dropdown-toggle">
								<i class="icon-f-39"></i>
								<!-- <span class="tt-badge-cart"> producttotal($_SESSION['cart']) </span> -->
							</a>
							...
							<div class="tt-dropdown-menu">
								...
								<div class="tt-dropdown-inner">
									<ul>
										...
										<?php if( $_SESSION['status'] == 'unverified'){ ?>
									    	<li><a href="verification"><i class="icon-f-94"></i>Verification</a></li>
									    <?php } ?>
										...
										<li><a href=""><i class="icon-f-68"></i>Check Out</a></li>
										
										<?php if(!isset($_SESSION['login'])){ ?>
									    <li><a href="login"><i class="icon-f-76"></i>Sign In</a></li>
										<?php } ?>
									    
										<li><a href="signout"><i class="icon-f-77"></i>Sign Out</a></li>
									   <!--  <li><a href="registeration.php"><i class="icon-f-94"></i>Register</a></li> -->
									</ul>
								</div>
							</div>
						</div>
...
<script>
	$('form').on('click', '#submit-search',function(e){
		e.preventDefault();
		var search = $('#search').val();
		window.location.href = 'all_products?q=' + search;
	});
